    ...
    const fullstackExperiences = [
        {
            ...
            responsibilities: [
                ...
                "Environment: React, Redux, Node.js, SQL, Redis, Python, FastAPI, Django, REST APIs, Git."
            ]
        },
        {
    ...
    const mobileExperiences = [
        {
            ...
            responsibilities: [
                ...
                "Environment: Node.js, Loopback 3.0, MySQL, MongoDB, Ionic, Typescript, Android, iOS"
            ]
        },
        {
            ...
            responsibilities: [
                ...
                "Environment: React, Angular, Ionic, Node.js, .NET"
            ]
        },
        {
            ...
            responsibilities: [
                ...
                "Environment: JavaScript, JSX, Webpack, Node.js, Linux, Genbox, Ionic, Android, React.js"
            ]
        },
        {
        ...
        },
        {
            ...
            responsibilities: [
                ...
                "Environment: Android, Java, HTML5, CSS3, JavaScript, AngularJS, jQuery, jQuery-mobile, PhoneGap, SQLite, J2EE, MongoDB, Apache Felix, SVG, WI-FI Commander, WinSCP, Putty, Ikivo, SVN, MKS"
            ]
        },
        {
